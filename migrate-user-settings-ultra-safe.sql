-- Ultra Safe Migration script to create user_settings table
-- Run this in your Supabase SQL editor
-- This script handles all dependencies gracefully
...
-- We'll just recreate our specific trigger for user_settings
